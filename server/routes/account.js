...
router.get('/api/v1/account/:id', auth.verifyToken, Account.getOneAccount);
...
router.get('/api/v3/account/draft',auth.verifyToken, Account.getDormantAccount);
router.get('/api/v4/account/dormant',auth.verifyToken, Account.getDraftAccount)
